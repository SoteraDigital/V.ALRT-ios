...
+ (ConfirmationView *) sharedInstance{
    
    // the instance of this class is stored here
    static ConfirmationView *myInstance = nil;
...
-(id)initWithView
{
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        arrayOfViews = [[NSBundle mainBundle] loadNibNamed:@"ConfirmationView"
                                                     owner:nil
                                                   options:nil];
    }
    ...
    ConfirmationView *newView = [arrayOfViews objectAtIndex:0];
...
-(void)didConfirmationViewLoad:(UIView *)parentView andConfirmationViewTitle:(NSString *)strConfirmationViewTitle andConfirmationViewContent:(NSString *)strConfirmationViewContent andConfirmationViewCallback:(OnConfirm)callback{
    ...
    [noBtn setTitle:NSLocalizedString(@"alrt_no", nil) forState:UIControlStateNormal];
    [yesBtn setTitle:NSLocalizedString(@"alrt_yes", nil) forState:UIControlStateNormal];
